...
void cubo() {
    glBegin(GL_QUADS); // Comienza el dibujo de los cuadriláteros
    ...
    glVertex3f(-0.5f, -0.5f, -0.5f); // Vértice inferior trasero
    glVertex3f(-0.5f, -0.5f,  0.5f); // Vértice inferior frontal
    glVertex3f(-0.5f,  0.5f,  0.5f); // Vértice superior frontal
    glVertex3f(-0.5f,  0.5f, -0.5f); // Vértice superior trasero
    ...
    // Cara superior (Y = 0.5)
    glVertex3f(-0.5f,  0.5f,  0.5f); // Vértice frontal izquierdo
    glVertex3f( 0.5f,  0.5f,  0.5f); // Vértice frontal derecho
    glVertex3f( 0.5f,  0.5f, -0.5f); // Vértice trasero derecho
    glVertex3f(-0.5f,  0.5f, -0.5f); // Vértice trasero izquierdo
